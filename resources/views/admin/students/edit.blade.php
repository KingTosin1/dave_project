                        ...
                        <form method="POST" action="{{ route('admin.students.update', $student) }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="matric_no" name="matric_no" value="{{ old('matric_no', $student->matric_no) }}" required>
                                    @error('matric_no') <div class="text-danger">{{ $message }}</div> @enderror
                                </div>

                                <div class="col-md-6 mb-3">
                                    <label for="department" class="form-label">Department</label>
                                    <input type="text" class="form-control" id="department" name="department" value="{{ old('department', $student->department) }}" required>
